...
public class GameControl : MonoBehaviour {
	...
	void Update () {
		...
		if ((cmt_plr.stats_value == 6) && (!CheckIn[4]) && (!GameObject.FindGameObjectWithTag("Player").GetComponent<Animator>().GetBool("happy"))) {
		...
		if (CheckIn [3]) {
			...
			if (!Dial [0]) {
				AudioSource.PlayClipAtPoint(fx[4],transform.position,0.5f);
				...
				obj_0.transform.position = new Vector2 (plr_mov.transform.position.x, plr_mov.transform.position.y + 1.5f); // Definimos Sua Posiçao
			...
			if (tempo_intervalo < Time.time - tempo_criaçao && !(Dial [1])) {
				AudioSource.PlayClipAtPoint(fx[5],transform.position,0.5f);
				...
				obj_1.transform.position = new Vector2 (plr_mov.transform.position.x - 1f, plr_mov.transform.position.y + 3.5f);
			...
			if (tempo_intervalo * 2f < Time.time - tempo_criaçao && !(Dial [2])) {
				...
				obj_2.transform.position = new Vector2 (plr_mov.transform.position.x - 2.8f, plr_mov.transform.position.y + 3.5f);
				if (transform.localScale.x > 0) { // Aqui Fazemos o Balao Nao Ficar Virado Para Direçao Errada
			...
			if (tempo_intervalo * 3f < Time.time - tempo_criaçao && !(Dial [3])) {
				AudioSource.PlayClipAtPoint(fx[6],transform.position,0.5f);
				...
				obj_3.transform.position = new Vector2 (plr_mov.transform.position.x - 1.9f, plr_mov.transform.position.y + 4f);
				if (transform.localScale.x > 0) { // Aqui Fazemos o Balao Nao Ficar Virado Para Direçao Errada
					obj_3.transform.localScale = new Vector2 (0.5f, 0.5f);
				} else {
					obj_3.transform.localScale = new Vector2 (-0.5f, 0.5f);
				}
				obj_3.tag = "Icon_0";
			...
			if (tempo_intervalo * 4f < Time.time - tempo_criaçao && !(Dial [4])) {
				AudioSource.PlayClipAtPoint(fx[0],transform.position,0.5f);
				...
				obj_4.transform.position = new Vector2 (plr_mov.transform.position.x + (0.8f * transform.localScale.x), plr_mov.transform.position.y + 1f);
				if (transform.localScale.x > 0) { // Aqui Fazemos o Balao Nao Ficar Virado Para Direçao Errada
					obj_4.transform.localScale = new Vector2 (0.3f, 0.3f);
				} else {
					obj_4.transform.localScale = new Vector2 (-0.3f, 0.3f);
				}
				obj_4.tag = "Icon_0";
				...
				// npc triste
				GameObject.Find("NPCF").GetComponent<Animator>().SetBool("sad" , true);
			}
			...
			if (tempo_intervalo * 6f < Time.time - tempo_criaçao && !(Dial [6])) {
				AudioSource.PlayClipAtPoint(fx[7],transform.position,0.5f);
				...
				obj_5.transform.position = new Vector2 (plr_mov.transform.position.x - 2f, plr_mov.transform.position.y + 4f);
				if (transform.localScale.x > 0) { // Aqui Fazemos o Balao Nao Ficar Virado Para Direçao Errada
			...
			if (tempo_intervalo * 7.5f < Time.time - tempo_criaçao && !(Dial [7])) {
				...
				obj_6.transform.position = new Vector2 (plr_mov.transform.position.x - 2f, plr_mov.transform.position.y + 4f);
				if (transform.localScale.x > 0) { // Aqui Fazemos o Balao Nao Ficar Virado Para Direçao Errada
			...
			if (tempo_intervalo * 10f < Time.time - tempo_criaçao && !(Dial [9])) {
				...
				Destroy (hud);
				AudioSource.PlayClipAtPoint(fx[3],transform.position,0.5f);
				...
				obj_7.transform.position = new Vector2 (plr_mov.transform.position.x + (0.8f * transform.localScale.x), plr_mov.transform.position.y + 1f);
				if (transform.localScale.x > 0) { // Aqui Fazemos o Balao Nao Ficar Virado Para Direçao Errada
					obj_7.transform.localScale = new Vector2 (0.3f, 0.3f);
				} else {
					obj_7.transform.localScale = new Vector2 (0.3f, 0.3f);
				}
				obj_7.tag = "Icon";
				...
				GameObject.Find("NPCF").GetComponent<Animator>().SetBool("sad" , false);
				GameObject.Find("NPCF").GetComponent<Animator>().SetBool("happy" , true);
			...
			if (Dial[9]){
				print ("roll credits");
				if (10f < Time.time - other_time){
					GameObject.Find ("BlackScreen").GetComponent<Intro>().status = 0;
					if (GameObject.Find ("BlackScreen").GetComponent<SpriteRenderer>().color.a == 1){
